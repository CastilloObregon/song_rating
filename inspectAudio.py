...
audio_data = 'Audios/fur_elise_4'
data, sr = librosa.load('Audios/fur_elise_01.mp3', sr=44100)

print(type(data), type(sr))#<class 'numpy.ndarray'> <class 'int'>print(x.shape, sr)#(94316,) 22050
